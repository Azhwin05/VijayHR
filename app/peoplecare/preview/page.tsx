...
export const metadata: Metadata = {
  ...
  description:
    "Strategic HR leadership, employee engagement and talent development under one accountable people partner — built on 24+ years of Vijay Associates' legacy.",
};

const solutions = [
  { name: "Talent Acquisition & Workforce Planning", tagline: "Attract and hire the right people, faster.", href: "/peoplecare/preview/solutions/talent-acquisition" },
  { name: "Onboarding & Employee Experience", tagline: "Strong first impressions that improve retention.", href: "/peoplecare/preview/solutions/onboarding" },
  { name: "Performance Management", tagline: "Clarity, accountability and growth at every level.", href: "/peoplecare/preview/solutions/performance-management" },
  { name: "Learning & Development", tagline: "Capability building that compounds.", href: "/peoplecare/preview/solutions/learning-development" },
  { name: "Employee Engagement & Culture", tagline: "Workplaces where people want to stay.", href: "/peoplecare/preview/solutions/engagement-culture" },
  { name: "Leadership Development", tagline: "Managers and supervisors who drive performance.", href: "/peoplecare/preview/solutions/leadership-development" },
  { name: "Organization Development", tagline: "Structures and processes built to scale.", href: "/peoplecare/preview/solutions/organization-development" },
  { name: "Talent Management & Succession Planning", tagline: "Protecting your future leadership.", href: "/peoplecare/preview/solutions/talent-succession" },
  { name: "Employee Communication", tagline: "Alignment from the boardroom to the shopfloor.", href: "/peoplecare/preview/solutions/employee-communication" },
  { name: "Retention & Career Development", tagline: "Keeping your best people, longer.", href: "/peoplecare/preview/solutions/retention-career" },
];
  ...
  return (
    <main>
      <Hero
        ...
        sub="Strategic HR leadership, employee engagement and talent development under one accountable people partner — built on 24+ years of Vijay Associates' legacy."
        ctas={[
          { label: "Book Consultation →", href: "/peoplecare/preview/contact" },
          { label: "Our Solutions", href: "/peoplecare/preview/solutions", variant: "outline" },
        ]}
        stats={[
      ...
      <WhyChoose
        ...
        items={[
          ...
          { title: "24+ years of Group legacy", text: "Backed by the Vijay Associates Group's uninterrupted track record since 2002." },
      ...
      <IndustriesTeaser
        ...
        ctaHref="/peoplecare/preview/industries"
      />
      ...
      <BenefitsGrid
        ...
        ctaHref="/peoplecare/preview/contact"
      />
